"""
Unit tests for the dyslexxy.utils.embedding module.
...
from dyslexxy.utils.chunking import CHUNK_SIZE
from dyslexxy.utils.embedding import (
    generate_embedding,
    generate_embeddings,
    mean_pool_embeddings,
)
from dyslexxy.utils.token_utils import token_count
...
class TestGenerateEmbeddings:
    ...
    async def test_no_model_raises(self):
        ...
        with patch(
            "dyslexxy.ai.models.model_manager.get_embedding_model",
...
class TestGenerateEmbedding:
    ...
    async def test_content_type_parameter(self):
        ...
        from dyslexxy.utils.chunking import ContentType
    ...
    async def test_batching(self):
        ...
        from dyslexxy.utils.embedding import EMBEDDING_BATCH_SIZE
    ...
    async def test_batch_retry_on_transient_failure(self):
        ...
        with (
            ...
            patch("dyslexxy.utils.embedding.EMBEDDING_RETRY_DELAY", 0),
        ):
            result = await generate_embeddings(texts)
    ...
    async def test_batch_retry_exhaustion(self):
        ...
        from dyslexxy.utils.embedding import EMBEDDING_MAX_RETRIES
...
class TestErrorClassifier413:
    ...
    def test_413_status_code(self):
        from dyslexxy.exceptions import ExternalServiceError
        from dyslexxy.utils.error_classifier import classify_error
