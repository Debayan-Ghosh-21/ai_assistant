export const esES = {
  ...
  connectionErrors: {
    ...
    apiDesc: "No se pudo alcanzar el servidor API de Dyslexxy",
    ...
    docLink: "Documentación de Dyslexxy",
  ...
  settings: {
    ...
    filesHelp: "Una vez que tus archivos se suben y procesan, ya no son necesarios. La mayoría de los usuarios deberían permitir que Dyslexxy elimine los archivos subidos de la carpeta de carga automáticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Una nueva versión de Dyslexxy está disponible.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura qué modelos usar para diferentes propósitos en Dyslexxy",
    missingRequiredModels: "Faltan modelos requeridos: {models}. Dyslexxy puede no funcionar correctamente sin estos.",
  ...
  apiKeys: {
    ...
    description: "Almacena claves API de forma segura en la base de datos para habilitar proveedores de IA en Dyslexxy.",
    encryptionRequired: "Clave de encriptación no configurada",
    encryptionRequiredDescription: "Establece la variable de entorno DYSLEXXY_ENCRYPTION_KEY con cualquier cadena secreta para habilitar el almacenamiento de claves API en la base de datos.",
  ...
  setupBanner: {
    encryptionRequired: "Clave de encriptación no configurada",
    encryptionRequiredDescription: "Establece la variable de entorno DYSLEXXY_ENCRYPTION_KEY para habilitar el almacenamiento seguro de credenciales.",
