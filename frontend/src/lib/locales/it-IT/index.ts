export const itIT = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Il server API di Dyslexxy non è raggiungibile",
    ...
    docLink: "Documentazione Dyslexxy",
  ...
  settings: {
    ...
    filesHelp: "Una volta caricati ed elaborati, i tuoi file non sono più necessari. La maggior parte degli utenti dovrebbe permettere a Dyslexxy di eliminare automaticamente i file caricati dalla cartella upload.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "È disponibile una nuova versione di Dyslexxy.",
    upToDate: "Aggiornato",
    unknown: "Sconosciuto",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura quali modelli usare per diversi scopi in Dyslexxy",
    missingRequiredModels: "Modelli richiesti mancanti: {models}. Dyslexxy potrebbe non funzionare correttamente senza questi.",
  ...
  apiKeys: {
    ...
    description: "Salva le chiavi API in modo sicuro nel database per abilitare i provider IA in Dyslexxy.",
    encryptionRequired: "Chiave di crittografia non configurata",
    encryptionRequiredDescription: "Imposta la variabile d'ambiente DYSLEXXY_ENCRYPTION_KEY su una stringa segreta qualsiasi per abilitare il salvataggio delle chiavi API nel database.",
  ...
  setupBanner: {
    encryptionRequired: "Chiave di crittografia non configurata",
    encryptionRequiredDescription: "Imposta la variabile d'ambiente DYSLEXXY_ENCRYPTION_KEY per abilitare l'archiviazione sicura delle credenziali.",
