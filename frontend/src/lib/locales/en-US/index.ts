export const enUS = {
  ...
  connectionErrors: {
    ...
    apiDesc: "The Dyslexxy API server could not be reached",
    ...
    docLink: "Dyslexxy Documentation",
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow Dyslexxy to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of Dyslexxy is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across Dyslexxy",
    missingRequiredModels: "Missing required models: {models}. Dyslexxy may not function properly without these.",
  ...
  apiKeys: {
    ...
    description: "Store API keys securely in the database to enable AI providers in Dyslexxy.",
    encryptionRequired: "Encryption key not configured",
    encryptionRequiredDescription: "Set the DYSLEXXY_ENCRYPTION_KEY environment variable to any secret string to enable storing API keys in the database.",
  ...
  setupBanner: {
    encryptionRequired: "Encryption key not configured",
    encryptionRequiredDescription: "Set the DYSLEXXY_ENCRYPTION_KEY environment variable to enable secure credential storage.",
