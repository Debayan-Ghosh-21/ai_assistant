export const frFR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Le serveur API de Dyslexxy est injoignable",
    ...
    docLink: "Documentation de Dyslexxy",
  ...
  settings: {
    ...
    filesHelp: "Une fois vos fichiers téléchargés et traités, ils ne sont plus nécessaires. La plupart des utilisateurs devraient autoriser Dyslexxy à supprimer automatiquement les fichiers du dossier de téléchargement.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Une nouvelle version de Dyslexxy est disponible.",
    upToDate: "À jour",
    unknown: "Inconnu",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configurez quels modèles utiliser pour les différents usages d'Dyslexxy",
    missingRequiredModels: "Modèles requis manquants : {models}. Dyslexxy pourrait ne pas fonctionner correctement sans eux.",
  ...
  apiKeys: {
    ...
    description: "Stockez les clés API de manière sécurisée dans la base de données pour activer les fournisseurs d'IA dans Dyslexxy.",
    encryptionRequired: "Clé de chiffrement non configurée",
    encryptionRequiredDescription: "Définissez la variable d'environnement DYSLEXXY_ENCRYPTION_KEY avec une chaîne secrète pour activer le stockage des clés API dans la base de données.",
  ...
  setupBanner: {
    encryptionRequired: "Clé de chiffrement non configurée",
    encryptionRequiredDescription: "Définissez la variable d'environnement DYSLEXXY_ENCRYPTION_KEY pour activer le stockage sécurisé des identifiants.",
