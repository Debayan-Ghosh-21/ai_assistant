export const ruRU = {
  ...
  connectionErrors: {
    ...
    apiDesc: "API-сервер Dyslexxy недоступен",
  ...
  settings: {
    ...
    filesHelp: "После загрузки и обработки файлы больше не нужны. Большинству пользователей следует разрешить Dyslexxy автоматически удалять загруженные файлы из папки загрузок.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Доступна новая версия Dyslexxy.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Настройте, какие модели использовать для различных задач в Dyslexxy",
    missingRequiredModels: "Отсутствуют необходимые модели: {models}. Dyslexxy может работать некорректно без них.",
  ...
  apiKeys: {
    ...
    description: "Храните API-ключи в базе данных для безопасного подключения провайдеров ИИ в Dyslexxy.",
    encryptionRequired: "Ключ шифрования не настроен",
    encryptionRequiredDescription: "Установите переменную окружения DYSLEXXY_ENCRYPTION_KEY в любую секретную строку для хранения API-ключей в базе данных.",
  ...
  setupBanner: {
    encryptionRequired: "Ключ шифрования не настроен",
    encryptionRequiredDescription: "Установите переменную окружения DYSLEXXY_ENCRYPTION_KEY для безопасного хранения учётных данных.",
