export const ptBR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "O servidor da API do Dyslexxy não pôde ser alcançado",
    ...
    docLink: "Documentação do Dyslexxy",
  ...
  settings: {
    ...
    filesHelp: "Uma vez que seus arquivos são enviados e processados, eles não são mais necessários. A maioria dos usuários deve permitir que o Dyslexxy exclua arquivos enviados da pasta de upload automaticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Uma nova versão do Dyslexxy está disponível.",
    upToDate: "Atualizado",
    unknown: "Desconhecido",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure quais modelos usar para diferentes propósitos no Dyslexxy",
    missingRequiredModels: "Modelos obrigatórios ausentes: {models}. O Dyslexxy pode não funcionar corretamente sem eles.",
  ...
  apiKeys: {
    ...
    description: "Armazene chaves de API com segurança no banco de dados para habilitar provedores de IA no Dyslexxy.",
    encryptionRequired: "Chave de criptografia não configurada",
    encryptionRequiredDescription: "Configure a variável de ambiente DYSLEXXY_ENCRYPTION_KEY com qualquer string secreta para armazenar chaves de API no banco de dados.",
  ...
  setupBanner: {
    encryptionRequired: "Chave de criptografia não configurada",
    encryptionRequiredDescription: "Configure a variável de ambiente DYSLEXXY_ENCRYPTION_KEY para habilitar o armazenamento seguro de credenciais.",
