...
Dyslexxy uses SurrealDB for its database needs. 

---

## Default Configuration

Dyslexxy should work out of the box with SurrealDB as long as the environment variables are correctly setup. 


### DB running in the same docker compose as Dyslexxy (recommended)
...
### DB running in the host machine and Dyslexxy running in Docker
...
### Dyslexxy and Surreal are running on the same machine
