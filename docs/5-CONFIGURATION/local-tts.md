...
> - **[docker-compose-speaches.yml](../../examples/docker-compose-speaches.yml)** - Speaches + Dyslexxy
...
```yaml
# In your Dyslexxy docker-compose.yml
environment:
...
### Dyslexxy in Docker (macOS/Windows)

**TTS Base URL:** `http://host.docker.internal:8969/v1`

### Dyslexxy in Docker (Linux)
...
# From inside Dyslexxy container
docker exec -it dyslexxy curl http://host.docker.internal:8969/v1/models
```
