...
Get Dyslexxy running locally in 5 minutes.
...
- **Frontend**: http://localhost:3000 → Dyslexxy UI
...
- **First Issue?** Pick a [good first issue](https://github.com/lfnovo/dyslexxy/issues?q=label%3A%22good+first+issue%22)
