...
Welcome to the Dyslexxy development documentation! Whether you're contributing code, understanding our architecture, or maintaining the project, you'll find guidance here.
...
For deeper dives, check `/dyslexxy/` CLAUDE.md for component-specific guidance.
