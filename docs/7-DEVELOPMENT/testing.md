...
This document provides guidelines for writing tests in Dyslexxy. Testing is critical to maintaining code quality and preventing regressions.
...
- Use `--cov` flag to check coverage: `uv run pytest --cov=dyslexxy`
