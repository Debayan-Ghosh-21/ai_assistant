# Contributing to Dyslexxy

Thank you for your interest in contributing to Dyslexxy! We welcome contributions from developers of all skill levels. This guide will help you understand our contribution workflow and what makes a good contribution.
...
2. **Create a bug report** - Use the [Bug Report template](https://github.com/lfnovo/dyslexxy/issues/new?template=bug_report.yml)
3. **Provide details** - Include:
   - Steps to reproduce
   - Expected vs actual behavior
   - Logs, screenshots, or error messages
   - Your environment (OS, Docker version, Dyslexxy version)
...
2. **Create a feature request** - Use the [Feature Request template](https://github.com/lfnovo/dyslexxy/issues/new?template=feature_request.yml)
...
Thank you for contributing to Dyslexxy! Your contributions help make research more accessible and private for everyone.
