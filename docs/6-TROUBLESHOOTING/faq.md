...
Common questions about Dyslexxy usage, configuration, and best practices.
...
Dyslexxy is an open-source, privacy-focused alternative to Google's Notebook LM. It allows you to:
...
- Use `DYSLEXXY_PASSWORD` for public deployments
...
Submit to: [GitHub Issues](https://github.com/lfnovo/dyslexxy/issues)
