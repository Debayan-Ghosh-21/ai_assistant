...
- Check that `DYSLEXXY_ENCRYPTION_KEY` is set in docker-compose.yml
...
3. **Update regularly** — Pull latest image: `docker pull lfnovo/dyslexxy:latest`
...
- **Ask for help:** [Discord](https://discord.gg/37XJPXfz2w) or [GitHub Issues](https://github.com/lfnovo/dyslexxy/issues)
