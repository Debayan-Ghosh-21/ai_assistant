...
Encryption is enabled when DYSLEXXY_ENCRYPTION_KEY environment variable
...
from dyslexxy.database.repository import ensure_record_id, repo_query, repo_upsert
from dyslexxy.domain.base import RecordModel
from dyslexxy.utils.encryption import decrypt_value, encrypt_value
...
class ProviderConfig(RecordModel):
    ...
    record_id: ClassVar[str] = "dyslexxy:provider_configs"
    ...
    def _prepare_save_data(self) -> dict:
        ...
        DYSLEXXY_ENCRYPTION_KEY is configured.
        """
        data = {"credentials": {}}
    ...
    async def save(self) -> "ProviderConfig":
        ...
        await repo_upsert("dyslexxy", self.record_id, data)
        return self
