...
- `dyslexxy.domain.base`: ObjectModel base class
- `dyslexxy.ai.models`: Model class (for `_resolve_model_config`)
- `dyslexxy.ai.key_provider`: provision_provider_keys (fallback)
- `dyslexxy.domain.credential`: Credential (for migration)
