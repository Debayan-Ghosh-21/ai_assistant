...
async def migrate_podcast_profiles() -> None:
        ...
        try:
            ...
            if needs_outline:
                ...
                if outline_provider and outline_model:
                    ...
                    if model_id:
                        from dyslexxy.database.repository import ensure_record_id
            ...
            if updates:
                from dyslexxy.database.repository import repo_update
    ...
    for raw in speaker_profiles:
        ...
        try:
            ...
            if model_id:
                from dyslexxy.database.repository import ensure_record_id, repo_update
