...
A flexible and generic ContextBuilder class for the Dyslexxy project that can handle any parameters and build context from sources, notebooks, insights, and notes.
...
```python
from dyslexxy.utils.context_builder import (
...
```python
from dyslexxy.utils.context_builder import ContextConfig
...
```python
from dyslexxy.utils.context_builder import ContextItem
...
The ContextBuilder integrates seamlessly with the existing Dyslexxy architecture:
