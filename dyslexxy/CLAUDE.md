...
### 5. Error Handling
- **Custom exceptions** (`exceptions.py`): Hierarchy rooted at `DyslexxyError` with typed subclasses (`AuthenticationError`, `ConfigurationError`, `RateLimitError`, `ExternalServiceError`, `NetworkError`, etc.)
...
- **Documentation**: https://dyslexxy.ai
- **Discord**: https://discord.gg/37XJPXfz2w
- **Issues**: https://github.com/lfnovo/dyslexxy/issues
