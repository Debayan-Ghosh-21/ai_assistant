"""
API client for Dyslexxy API.
This module provides a client interface to interact with the Dyslexxy API.
"""
...
class APIClient:
    ...
    def __init__(self, base_url: Optional[str] = None):
        ...
        self.headers = {}
        password = os.getenv("DYSLEXXY_PASSWORD")
        if password:
