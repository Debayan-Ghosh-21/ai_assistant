...
from dyslexxy.domain.credential import Credential
...
def require_encryption_key() -> None:
    ...
    if not get_secret_from_env("DYSLEXXY_ENCRYPTION_KEY"):
        raise ValueError(
            ...
            "Set DYSLEXXY_ENCRYPTION_KEY to enable storing API keys."
        )
...
async def get_provider_status() -> dict:
    ...
    """
    encryption_configured = bool(get_secret_from_env("DYSLEXXY_ENCRYPTION_KEY"))
...
async def test_credential(credential_id: str) -> dict:
    ...
    try:
        ...
        from dyslexxy.ai.connection_tester import (
        ...
        from dyslexxy.ai.connection_tester import TEST_MODELS
...
async def register_models(credential_id: str, models_data: list) -> dict:
    ...
    from dyslexxy.database.repository import repo_query
...
async def migrate_from_provider_config() -> dict:
    ...
    from dyslexxy.domain.provider_config import ProviderConfig
