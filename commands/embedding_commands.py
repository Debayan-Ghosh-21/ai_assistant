...
from dyslexxy.ai.models import model_manager
from dyslexxy.database.repository import ensure_record_id, repo_insert, repo_query
from dyslexxy.exceptions import ConfigurationError
from dyslexxy.domain.notebook import Note, Source, SourceInsight
from dyslexxy.utils.chunking import ContentType, chunk_text, detect_content_type
...
@command("rebuild_embeddings", app="dyslexxy", retry=None)
